...
- Logistics uses internal building inventories plus deterministic, recipe-validated links. Completed storage and producers send configured-throughput inputs into completed producers; priority ordering reserves source and target capacity per tick, preserves output space for active batches, and reports congestion or recipe reconfiguration. Carriers, roads, belts, and routing remain future work.

...
export const rejectionMessage = (code: string | undefined) => {
  const messages: Record<string, string> = {
    ...
    'unknown-landmark': 'Explore that landmark before deciding its future.',
    'landmark-already-resolved': 'That landmark decision is permanent.',
    'initiative-active': 'Wait for the current settlement initiative to finish.',
